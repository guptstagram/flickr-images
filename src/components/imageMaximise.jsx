...
import "../styles/imageMaximise.css";
import { useSelector, useDispatch } from "react-redux";
import { minimiseImage } from "../actions/maximiseImageAction";

const ImageMaximise = () => {
  const dispatch = useDispatch();
  const imageDetails = useSelector((state) => state.maximiseImageReducer);

  const handleCrossClick = () => {
    dispatch(minimiseImage());
    document.body.style.overflow = 'unset';
  };

  return (
    <div className="maximised-image">
      <div className="img-container">
        ...
        <img
          src={`https://live.staticflickr.com/${imageDetails.server}/${imageDetails.id}_${imageDetails.secret}.jpg`}
